  ...
  return (
    <div>
      ...
      {blogs.map((blog, index) => (
        ...
        <div className=" text-gray-900 grid gap-12">
          <div className="container grid grid-cols-12 gap-12 mx-auto border bg-gray-50">
            <div className="bg-no-repeat bg-cover bg-gray-700 col-span-full lg:col-span-4" style={{ backgroundImage: "url('https://source.unsplash.com/random/640x480')", backgroundPosition: "center center", backgroundBlendMode: "multiply", backgroundSize: "cover" }}></div>
