    ...
    <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32  text-gray-800">
				<div className="flex flex-col justify-between">
					<div className="space-y-2">
						...
						<div className="text-gray-600">In the comfort of your home we conduct House Visits any time at your convenience.
						Drop us a message and we will get back to you within a day.</div>
					</div>
				...
				<form novalidate="" className="space-y-6">
					...
					<button type="submit" className="w-full p-3 text-sm font-bold tracki uppercase rounded bg-[#7CC23E] text-gray-50">Send Message</button>
				</form>
			</div>
