        ...
        <section className="text-gray-800">
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                ...
                <div className="space-y-2">
                    ...
                    {/* Remove <p> tags wrapping <ul> element */}
                    <details className="border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ring">
                        ...
                        <div className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-600">
                            <ul className="list-disc pl-4">
                                <li>Employers must pay for the maid's salary, food, accommodation, and medical expenses. Employers must also pay a monthly levy to the MOM.</li>
                            </ul>
                        </div>
                    </details>
