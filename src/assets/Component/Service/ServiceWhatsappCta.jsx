...
const ServiceWhatsappCta = () => {
  return (
	...
	<div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:flex-row lg:justify-between">
		<h1 className="text-3xl uppercase font-rubik leading-3 text-center lg:text-left">Wanted to learn more? <br /><br /> <br /> <span className=' text-gray-600 text-xl italic'>Text us to learn more about our service.</span>
        </h1>
